...
export default function Page1() {
  ...
  const party2 = [
    // {id:1 , name:'event1' , description1:'this is the second party'},
    {
      ...
      name1: "event1",
      description1:
        "🔥 An unforgettable adventure in the heart of the desert! 🔥Embark on an exciting and thrilling desert cycling experience, with golden sands and exciting trails waiting for you. Experience the pleasure of driving amidst the sand dunes and enjoy the enchanting desert nature.Whether you are an adventure lover or looking for a new adrenaline-filled experience, our trip gives you the opportunity to discover the desert in a different and fun way, with modern equipment and professional guidance to ensure a safe and fun experience.🏜 Enjoy the stunning views🏍 Live an action-packed driving experience👨‍👩‍👧 Suitable for friends, families and adventure lovers",
      image:
        "https://i.pinimg.com/1200x/08/d3/0b/08d30b867ba3ada50c4e06f8287d3b36.jpg",
    },
    {
      id: 2,
      name2: "event2",
      description2:
        "Whether you are a beginner or a professional, the horse riding experience will give you the opportunity to enjoy the stunning scenery, and feel free while setting off confidently between the open paths. Carefully trained horses are provided with specialist supervision to ensure a safe and enjoyable experience for everyone.✨ An experience that combines fun and relaxation🐎 Trained horses suitable for all levels🌿 Charming natural atmosphere, ideal for photography👨‍👩‍👧 Suitable for individuals, families and adventure lovers",
      image:
        "https://i.pinimg.com/736x/63/56/20/635620b1bd58aa436708973653d5b381.jpg",
    },
    {
      id: 3,
      name4: "event3",
      description3: "this is the fourth party",
      image:
        "https://i.pinimg.com/736x/e8/9e/00/e89e00add913e579a735f0b19c163581.jpg",
    },
        ...
        <CardActionArea>
          ...
          <CardContent>
            ...
            <Typography variant="body2" sx={{ color: "text.secondary" }}>
              🎉✨ Get ready for an atmosphere full of fun and excitement! Our
              parties combine great music, dancing, and an unforgettable festive
              ...
              {party.map((item) => (
                <li key={item.id}>
                  <div>
                    ...
                    <Link to="/page-event" state={item}>
                      <button id="button1">View Event</button>
                    </Link>
                  </div>
                </li>
              ))}
      ...
      <Card >
        <CardActionArea>
          ...
          <CardContent>
            ...
            <Typography variant="body2" sx={{ color: "text.secondary" }}>
              🏜️✨ Live an unforgettable adventure amidst the sand dunes! Enjoy
              camel riding, safaris, and sandboarding under the enchanting
              desert sky. 🌟🐪
            </Typography>
          </CardContent>
        </CardActionArea>
      ...
      <Card>
        <CardActionArea>
          ...
          <CardContent>
            ...
            <Typography variant="body2" sx={{ color: "text.secondary" }}>
              🎬✨ Enjoy an unforgettable cinematic experience! Watch the latest
              movies on a big screen, enjoy amazing sound and picture, and
              immerse yourself in a world of stories and adventures. 🍿🌟
            </Typography>
          </CardContent>
        </CardActionArea>
        <CardActions>
              ...
              {party3.map((item) => (
                <li key={item.id}>
                  <div>
                    ...
                    <Link to="/page-event" state={item} className="link">
                      <button id="button1">View Event</button>
                    </Link>
                  </div>
                </li>
